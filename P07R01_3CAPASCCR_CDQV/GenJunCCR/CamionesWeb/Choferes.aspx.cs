...
namespace CamionesWeb
{
    public partial class Choferes : System.Web.UI.Page
    {
        ...
        //Guardar camion
        //protected void btnGuardarChofer_Click(object sender, EventArgs e)
        //{
        //    try
        //    {
        ...
        //        chofer.ApPaterno = txtTipo.Text.Trim();
        //        chofer.ApMaterno = txtMarca.Text.Trim();
        ...
        //{
        //    int idChofer = Convert.ToInt32(e.CommandArgument);
        ...
        //    }
            ...
            //==========================================================================Metodo para obtener choferes por id
            //if (e.CommandName == "Editar")
            //{

            //    var camion = objNegocio.ObtenerChoferPorId(idChofer);
