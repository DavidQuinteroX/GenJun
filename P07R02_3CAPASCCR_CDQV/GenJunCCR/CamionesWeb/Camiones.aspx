        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="header-title mb-0">Gestión de Camiones</</h1>
    ...
    <div class="card">
        ...
        <div class="action-bar">
            ...
            <div class="action-actions">
                <button type="button" class="btn btn-primary-grad" onclick="abrirModal()">➕ Nuevo Camión</button>
                <span class="btn-wrap search">
                    <asp:Button type="button" runat="server" ID="btnFiltrar" Text=" Buscar" class="btn btn-outline-primary" OnClick="btnFiltrar_Click"></asp:Button>
                </span>
                <span class="btn-wrap refresh">
                    <asp:Button type="button" runat="server" Text=" Actualizar" class="btn btn-outline-primary" ID="btnActualizarh" OnClick="btnActualizar_Click"></asp:Button>
        ...
        <!-- TABLE -->
        <div class="table table-modern align-middle mb-0">
